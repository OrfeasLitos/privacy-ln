\section{Lightning Protocol}
  ...
  \textsc{receive} messages to and from \anonfunc with \bob as the sender and
  the receiver respectively. \bob is a ``logical'' (LN-only) address,
  therefore \alice need not know \bob's ``real'' address. This address is only
  known by \anonfunc.
